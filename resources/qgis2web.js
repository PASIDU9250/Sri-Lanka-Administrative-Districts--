...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([76.106678, 5.614424, 85.356178, 9.969771], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sri Lanka Administrative Districts</h2>';
        return titleElement;
    })(),
